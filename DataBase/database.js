...
function setupDatabase(err) {
  ...
  var tablesql = "CREATE TABLE testtable(id INT AUTO_INCREMENT PRIMARY KEY, name VARCHAR(255), image VARCHAR(255), price DECIMAL(5,2), type VARCHAR(2), description VARCHAR(255))"
  con.query(tablesql, function (err) {
    if (err) throw err;
    console.log("Test table created");
  })

  var insertsql = "INSERT INTO testtable (name, image,price,type, description) VALUES('boba tea','https://www.unionsquareawards.org/wp-content/uploads/2019/09/images3904-5d882e0c1594c.jpg',2.50,'t', 'desc 1'),"
